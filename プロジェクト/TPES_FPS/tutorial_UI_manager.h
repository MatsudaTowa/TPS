//=============================================
//
//チュートリアル表示「tutorial_UI_manager.h」
// Author松田永久
//
//=============================================
#ifndef _TUTORIAL_UI_MANAGER_H_ //これが定義されてないとき
#define _TUTORIAL_UI_MANAGER_H_
#include "main.h"
#include "object2D.h"
#include "number.h"
#include "action_UI.h"
...
//チュートリアルUIクラス
//=============================================
class CTutorial_UI_Manager
{
public:
	CTutorial_UI_Manager();
	~CTutorial_UI_Manager();
	HRESULT Init();
	void Uninit();
	void Update();
